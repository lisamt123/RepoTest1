...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    <customApplicationComponents>
        ...
        <customApplicationComponent>NitroServiceBar</customApplicationComponent>
        <customApplicationComponent>Console.BuiltInComponent.knowledgeOne</customApplicationComponent>
    </customApplicationComponents>
    <defaultLandingTab>standard-home</defaultLandingTab>
    <description>Service Console for VinSolutions Support</description>
    ...
    <label>VinSolutions Support Console</label>
    <listPlacement>
